                ...
                <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
                    <div>
                        ...
                        <p className="text-slate-500 mt-2 text-lg">
                            Administra los usuarios y niveles de acceso de tu organización.
                        </p>
                    </div>
                    {isAdminOrOwner && (
                        <button
                    ...
                    <div className="block md:hidden divide-y divide-slate-100">
                        {loading ? (
                            ...
                            filteredUsers.map(user => (
                                <div key={user.usuario_id} className="p-5 bg-white space-y-4">
                                    ...
                                    <tr>
                                        <td colSpan={5} className="px-8 py-20 text-center">
                                            <div className="flex flex-col items-center gap-3">
                                                ...
                                                <p className="text-slate-400 font-bold tracking-tight">No se encontraron integrantes con esos criterios</p>
                                            </div>
                                        </td>
                                    </tr>
                                ) : (
                                    filteredUsers.map((user) => (
                                        <tr key={user.usuario_id} className={`group hover:bg-teal-50/30 transition-all duration-300 ${user.estado === 'INACTIVO' ? 'opacity-70 grayscale-[0.5]' : ''}`}>
